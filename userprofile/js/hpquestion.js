...
$('#menu2').css({"background":"url('images/mhoverbg.png')","background-repeat":"no-repeat","padding-bottom":"20px","position":"relative",
"top":"-1px","padding-top":"7px","padding-left":"20px","padding-right":"20px"});
	},function(){
...
$('#menu2').css({"background":"url('images/mhoverbg.png')","background-repeat":"no-repeat","padding-bottom":"20px","position":"relative",
"top":"-1px","padding-top":"7px","padding-left":"20px","padding-right":"20px"});},function(){
$('#menu2').css({"background-image":"none"});
	});
